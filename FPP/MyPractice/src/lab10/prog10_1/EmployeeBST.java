...
public class EmployeeBST {
	...
	private boolean find(Employee e, Node n){
		...
		if(n != null && n.employee.equals(e)) return true;
		
		return (nameComp.compare(e, n.employee) < 0) ?
				find(e,n.left) :
				find(e,n.right);
	...
	public void insert(Employee e) {
		if (root == null) {
			...
			while(!inserted){
				if(nameComp.compare(e, n.employee) < 0) {
				...
				else if(nameComp.compare(e, n.employee) >=0){ 
