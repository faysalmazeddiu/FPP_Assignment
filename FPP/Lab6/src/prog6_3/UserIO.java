...
import prog6_3.accounts.Employee;
...
public class UserIO extends JFrame  {
	...
	public UserIO() {
		...
		getDataFromMainClass();
		//pack();
			
	}
	
	private void getDataFromMainClass() {
		emps = new Employee[3];
		...
		emps[1].createNewRetirement(31000);
	...
	//implemented
	public void setOutputValue(String userInput){
	...
	String getFormattedAccountInfo() {
		...
		for (Employee employee : emps) {
			outputString += employee.getFormattedAcctInfo();
		}
		return outputString;
	}
